...
import com.iman.submission1_storyapp.network.StoryUploadResponse
import com.iman.submission1_storyapp.databinding.ActivityAddStoryBinding
        ...
        binding.apply {
            ...
            scope.launch {
                ...
                withContext(Dispatchers.Main) {
                    val service = ApiConfig().getApiService().doUploadStory(token, img, description)
